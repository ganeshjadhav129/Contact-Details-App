...
public class ContactList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String whereClouse="userEmail = '" + RealApplication.user.getEmail() + "'";
        DataQueryBuilder dataQueryBuilder=DataQueryBuilder.create();
        dataQueryBuilder.setWhereClause(whereClouse);
        dataQueryBuilder.setGroupBy("name");
        showProgress(true);
        tvLoad.setText("Getting Contact List,Please Wait.!!");
        Backendless.Persistence.of(Contact.class).find(dataQueryBuilder, new AsyncCallback<List<Contact>>() {
            ...
            public void handleResponse(List<Contact> response) {
                RealApplication.userlistt=response;
                myadapter=new ContactAdapter(ContactList.this,RealApplication.userlistt);
